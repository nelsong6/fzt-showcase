...
- **GitHub links in hero**: Added two links below the tagline — "GitHub" pointing to the main fzh tool repo (`nelsong6/fuzzy-tiered`) and "Source" pointing to the showcase repo (`nelsong6/fuzzy-tiers-showcase`). Styled with retro green color and phosphor glow on hover.
